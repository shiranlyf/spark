package com.ishiran.sparkproject.spark.page;
...
import com.ishiran.sparkproject.domain.PageSplitConvertRate;
...
public class PageOneStepConvertRateSpark {
	...
	public static void main(String[] args) {
		...
		//{"targetPageFlow":["1,2,3,4,5,6,7,8,9"],"startDate":["2018-06-05"],"endDate":["2018-06-06"]}
		// 1、构造Spark上下文
		...
		System.out.println("----------------taskParam---------" + task.getTaskParam());
	...
	private static Map<String, Double> computePageSplitConvertRate(
		...
		for(int i = 1; i < targetPages.length; i++) {
			String targetPageSplit = targetPages[i - 1] + "_" + targetPages[i];
			System.out.println("-------hello---------" + targetPageSplit);
			System.out.println("----------value---------" + pageSplitPvMap.get(targetPageSplit));
		}
